...
void ASandboxPlayerController::SetupInputComponent()
{
    ...
    if (InputComponent) // Компонент, который обрабатывает ввод для этого актера, если ввод включен.
    {
...
void ASandboxPlayerController::ChangePawn() 
{
    ...
    UE_LOG(LogSandboxPlayerController, Display, TEXT("Change player pawn"));
